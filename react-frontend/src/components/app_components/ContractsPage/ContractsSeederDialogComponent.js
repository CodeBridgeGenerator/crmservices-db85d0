...
import seederData from "./contracts.seeder.json";
...
const ContractsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContractsSeederDialogComponent);
