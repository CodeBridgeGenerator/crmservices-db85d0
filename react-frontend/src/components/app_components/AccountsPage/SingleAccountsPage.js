...
const SingleAccountsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("accounts")
            .get(urlParams.singleAccountsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleAccountsId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>accounts/{urlParams.singleAccountsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Industry</label><p className="m-0 ml-3" >{_entity?.industry}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Notes</label><p className="m-0 ml-3" >{_entity?.notes}</p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Contacts" leftIcon="pi pi-building-columns mr-2">
                        <ContactsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Opportunities" leftIcon="pi pi-building-columns mr-2">
                        <OpportunitiesPage/>
                    </TabPanel>
      ...
      <CommentsSection
        recordId={urlParams.singleAccountsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleAccountsPage);
