...
const AccountsDataTable = ({
  ...
  const dropdownArrayTemplate6 = (rowData, { rowIndex }) => (
    <p>{rowData.status}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Industry"
          body={pTemplate1}
          filter={selectedFilterFields.includes("industry")}
          hidden={selectedHideFields?.includes("industry")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Website"
          body={pTemplate2}
          filter={selectedFilterFields.includes("website")}
          hidden={selectedHideFields?.includes("website")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
