...
import seederData from "./accounts.seeder.json";
...
const AccountsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AccountsSeederDialogComponent);
