    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Last Name"
          body={pTemplate2}
          filter={selectedFilterFields.includes("lastName")}
          hidden={selectedHideFields?.includes("lastName")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Job Title"
          body={pTemplate3}
          filter={selectedFilterFields.includes("jobTitle")}
          hidden={selectedHideFields?.includes("jobTitle")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
