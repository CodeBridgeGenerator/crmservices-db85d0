...
const NegotiationsDataTable = ({
  ...
  const p_calendarTemplate1 = (rowData, { rowIndex }) => (
    <p>{moment(rowData.negotiationDate).fromNow()}</p>
  );
  const dropdownArrayTemplate2 = (rowData, { rowIndex }) => (
    <p>{rowData.status}</p>
  );
  const p_numberTemplate3 = (rowData, { rowIndex }) => (
    <p>{rowData.offeredAmount}</p>
  );
  const p_numberTemplate4 = (rowData, { rowIndex }) => (
    <p>{rowData.counterAmount}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Negotiation Date"
          body={p_calendarTemplate1}
          filter={selectedFilterFields.includes("negotiationDate")}
          hidden={selectedHideFields?.includes("negotiationDate")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("offeredAmount")}
          hidden={selectedHideFields?.includes("offeredAmount")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="counterAmount"
          header="Counter Amount"
          body={p_numberTemplate4}
          filter={selectedFilterFields.includes("counterAmount")}
          hidden={selectedHideFields?.includes("counterAmount")}
          sortable
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload Negotiations Data"
        visible={showUpload}
