...
notes: _entity?.notes,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info negotiations updated successfully" });
    ...
    return (
        <Dialog header="Edit Negotiations" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="negotiations-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="negotiationDate" value={_entity?.negotiationDate ? new Date(_entity?.negotiationDate) : null} onChange={ (e) => setValByKey("negotiationDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="offeredAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.offeredAmount} onChange={(e) => setValByKey("offeredAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="counterAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.counterAmount} onChange={(e) => setValByKey("counterAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
