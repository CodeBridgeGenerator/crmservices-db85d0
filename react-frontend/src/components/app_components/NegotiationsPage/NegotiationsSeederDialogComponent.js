...
import seederData from "./negotiations.seeder.json";
...
const NegotiationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(NegotiationsSeederDialogComponent);
