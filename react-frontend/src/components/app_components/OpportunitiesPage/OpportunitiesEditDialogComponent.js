...
closedDate: _entity?.closedDate,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info opportunities updated successfully" });
...
const primaryContactIdOptions = primaryContactId.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Opportunities" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="opportunities-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="probability" className="w-full mb-3 p-inputtext-sm" value={_entity?.probability} onChange={(e) => setValByKey("probability", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="expectedCloseDate" value={_entity?.expectedCloseDate ? new Date(_entity?.expectedCloseDate) : null} onChange={ (e) => setValByKey("expectedCloseDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="closedDate" value={_entity?.closedDate ? new Date(_entity?.closedDate) : null} onChange={ (e) => setValByKey("closedDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
