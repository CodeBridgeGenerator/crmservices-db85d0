...
import seederData from "./opportunities.seeder.json";
...
const OpportunitiesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OpportunitiesSeederDialogComponent);
