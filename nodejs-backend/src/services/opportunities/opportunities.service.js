const { Opportunities } = require("./opportunities.class");
const createModel = require("./opportunities.model");
...
module.exports = function (app) {
  ...
  app.use("/opportunities", new Opportunities(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("opportunities");

  // Get the schema of the collections 
  app.get("/opportunitiesSchema", function (request, response) {
