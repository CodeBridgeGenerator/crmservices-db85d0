const { Negotiations } = require("./negotiations.class");
const createModel = require("./negotiations.model");
const hooks = require("./negotiations.hooks");
...
module.exports = function (app) {
  ...
  app.use("/negotiations", new Negotiations(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("negotiations");

  // Get the schema of the collections 
  app.get("/negotiationsSchema", function (request, response) {
