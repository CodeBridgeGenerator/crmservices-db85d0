...
firstName: { type:  String , required: true, minLength: 1, maxLength: 100, index: true, trim: true, comment: "First Name, p, false, true, true, true, true, true, true, , , , ," },
lastName: { type:  String , required: true, minLength: 1, maxLength: 100, index: true, trim: true, comment: "Last Name, p, false, true, true, true, true, true, true, , , , ," },
jobTitle: { type:  String , maxLength: 150, trim: true, comment: "Job Title, p, false, true, true, true, true, true, true, , , , ," },
